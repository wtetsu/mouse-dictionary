...
const JapaneseTextResource: TextResource = {
  ...
  width: "幅",
  height: "高さ",
  eitangoConnection: "つながる英単語連携",
  eitangoEmail: "つながる英単語メールアドレス",
  eitangoPassword: "つながる英単語パスワード",
  initialPosition: "初期表示位置",
  scrollBar: "スクロールバー",
  dictionaryData: "辞書データリセット",
  ...
  htmlTemplateDescText: "HTMLテンプレート",
  styles: "状態ごとのスタイル",
  ...
  downloadDictData: "追加辞書データのダウンロード",
  setKeyboardShortcuts: "キーボードショートカットの設定",
  windowManipulation: "ウィンドウ操作方法",
